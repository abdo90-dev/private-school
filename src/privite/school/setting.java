...
jScrollPane3.getViewport().setBackground(new Color(0,0,204));
    ...
    private void update_table3(JTable t){
        try {
            String sql="";
            if (t==jTable1) {
              sql = "select الإسم,الوظيفة from users ";  
            } else{ if (t==jTable2) {
              sql = "select  الإسم, الوظيفة from employee ";
            } else {
              sql = "select الإسم ,السعر from cost ";
            }}
    ...
    private void initComponents() {
        ...
        jLabel71.setText("الاسم المستخدم");
        ...
        jComboBox9.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "مدير", "أمين المدرسة", "آخر" }));
        ...
        jPanel16Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel16Layout.createSequentialGroup()
                ...
                .addGroup(jPanel16Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(jLabel73, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 92, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel82, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 92, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel74, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 92, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(79, 79, 79))
        );
        ...
        jLabel77.setText("الاسم التكلفة");
        ...
        jLabel80.setText("تاريخ بداية الدفع");
        ...
        jLabel93.setText("الاسم و اللقب");
                ...
                .addGroup(jPanel20Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(jPanel20Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel20Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(jLabel91, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 92, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(jLabel90, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 92, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(jLabel92, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 92, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jLabel96.setText("الاسم التكلفة");
        ...
        jLabel97.setText("تاريخ بداية الدفع");
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "عمال", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", 0, 18), new java.awt.Color(255, 255, 255))); // NOI18N
        ...
        jPanel5.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "مصاريف", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", 0, 18), new java.awt.Color(255, 255, 255))); // NOI18N
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "مستخدمون", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", 0, 18), new java.awt.Color(255, 255, 255))); // NOI18N
        ...
        jLabel200.setIcon(new javax.swing.ImageIcon("E:\\fr\\2-Hot-Home-icon.png")); // NOI18N
    ...
    private void jLabel76MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel76MouseClicked
                            ...
                            try {
                                String sql ="Insert into users (الإسم,'كلمة السر',الوظيفة) values (?,?,?)";
                                pst = con.prepareStatement(sql);
    ...
    private void jLabel84MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel84MouseClicked
        ...
        try {
                                String sql ="Insert into employee (الإسم,الراتب,'رقم الهاتف',الوظيفة) values (?,?,?,?)";
                                pst = con.prepareStatement(sql);
    ...
    private void jLabel88MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel88MouseClicked
        ...
        try {
                                String sql ="Insert into cost (الإسم ,تاريخ,المدة,العدد,السعر,التاريخ) values (?,?,?,?,?,?)";
                                pst = con.prepareStatement(sql);
                                ...
                                JOptionPane.showMessageDialog(null, e);
                                JOptionPane.showMessageDialog(null, "إسم التكلفة يجب الا يتكرر");
                            }finally{
                                try {
                                    pst.close();
                                } catch (SQLException ex) {
    ...
    private void jLabel8MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel8MouseClicked
...

        {
            ...
            try {
                String que = "delete from cost where \"إسم التكلفة\"='"+table_click+"'";
            ...
            JOptionPane.showMessageDialog(null, "من فضلك حدد التكلفة التي تريد حذفه");
        }
        update_table3(jTable2);
    ...
    private void jLabel2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel2MouseClicked
      ...
      String table_click =(jTable1.getModel().getValueAt(rw, 0).toString());
           try {
                String que = "delete from users where الإسم ='"+table_click+"'";
                pst = con.prepareStatement(que);
            ...
            JOptionPane.showMessageDialog(null, "من فضلك حدد المستخدم الذي تريد حذفه");
        }
            update_table3(jTable1);
    ...
    private void jLabel5MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel5MouseClicked
        ...
        if(p==0)
        {
           ...
           try {
                String que = "delete from employee where الإسم='"+table_click+"'";
                pst = con.prepareStatement(que);
            ...
            JOptionPane.showMessageDialog(null, "من فضلك حدد العامل الذي تريد حذفه");
        }
            update_table3(jTable2);
    ...
    private void jLabel102MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel102MouseClicked
        ...
        try {
            String query = "update cost set 'الإسم'='"+jTextField17.getText()+"' , السعر = '"+jTextField18.getText()+"' ,  تاريخ = '"+date+"', المدة = '"+peroid+"',العدد = '"+number+"',التاريخ ='"+date2+"'  where id ='"+jLabel3.getText()+"' ";
    ...
    private void jLabel4MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel4MouseClicked
         ...
         try {
            ...
            String table_click =(jTable2.getModel().getValueAt(rw, 0).toString());
            try {       
            String query="select *from employee where الإسم='"+table_click+"'";
            pst = con.prepareStatement(query);
            rs= pst.executeQuery();
            if (rs.next()) {
                ...
                jTextField15.setText(add2);
                 String add4 = rs.getString("الراتب");
                jTextField14.setText(add4);     
                String add3 = rs.getString("الوظيفة");
            ...
            JOptionPane.showMessageDialog(null, "من فضلك حدد العامل الذي تريد تعديل بياناته");
        }
    ...
    private void jLabel7MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel7MouseClicked
        try {
            ...
            String table_click =(jTable3.getModel().getValueAt(rw, 0).toString());
            try {       
            String query="select *from cost where \"الإسم\"='"+table_click+"'";
            pst = con.prepareStatement(query);
            rs= pst.executeQuery();
            ...
            if (rs.next()) {
                ...
                jLabel3.setText(add7);
                 ...
                 jTextField20.setEnabled(false);
                 jTextField21.setEnabled(false);
                 String add5= rs.getString("العدد");
    ...
    private void jLabel95MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel95MouseClicked
       ...
       try {
            String query = "update employee set الإسم='"+jTextField13.getText()+"' , 'رقم الهاتف' = '"+jTextField15.getText()+"' ,  الراتب = '"+jTextField14.getText()+"'  where id ='"+jLabel10.getText()+"' ";
            pst = con.prepareStatement(query);
            pst.execute();
